...
<body class="hold-transition bg-img" style="background-image: url('https://i.imgur.com/HgflTDf.jpg');" data-overlay="4">
                ...
                <div class="row no-gutters justify-content-md-center">
                    <div class="col-lg-4 col-md-5 col-12">
                        <div class="content-top-agile h-p100">
                            ...
                            <img src="../image/smai.png" width="120px" height="120px">
