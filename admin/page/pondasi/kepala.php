...
<head>
    ...
    <link rel="icon" href="../../image/smai.png">
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="index.php" class="logo">
                <!-- mini logo -->
                <div class="logo-mini">
                    <span class="light-logo"><img src="../../image/smai.png" width="20px" height="20px" alt="logo"></span>
                    <span class="dark-logo"><img src="../../image/smai.png" width="50px" height="50px" alt="logo">
                        ADMINISTRATOR</span>
                </div>
                <!-- logo-->
