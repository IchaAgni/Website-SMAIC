                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label>Edit Data Tujuan</label>
                                            <textarea rows="5" class="form-control" name="tujuan" value="<?php echo $b['tujuan'] ?>" required><?php echo $b['tujuan'] ?></textarea>

                                        </div>
                                        <div class="form-group">
                                            <label>Edit Data Budaya</label>
                                            <textarea rows="5" class="form-control" name="budaya" value="<?php echo $b['budaya'] ?>" required><?php echo $b['budaya'] ?></textarea>
